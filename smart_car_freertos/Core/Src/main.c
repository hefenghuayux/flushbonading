...
int main(void)
{
  ...
  osThreadDef(robot_move, robot_move_task, osPriorityNormal, 0, 128);
...
/* USER CODE BEGIN Header_robot_move_task */
/**
* @brief Function implementing the robot_move thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_robot_move_task */
void robot_move_task(void const * argument)
{
...
/* USER CODE BEGIN Header_HC_05_Task */
/**
* @brief Function implementing the HC_05 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_HC_05_Task */
void HC_05_Task(void const * argument)
{
